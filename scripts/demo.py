...
Usage:
    ...
    python scripts/demo.py --checkpoint path.pt      # Use specific checkpoint
    python scripts/demo.py --task copy               # Specify task
    python scripts/demo.py --show-attention          # Visualize attention weights
"""
