...
Usage:
    python scripts/benchmark.py                    # Run all tasks
    python scripts/benchmark.py --task copy        # Run specific task
    python scripts/benchmark.py --quick            # Quick mode (fewer epochs)
"""
